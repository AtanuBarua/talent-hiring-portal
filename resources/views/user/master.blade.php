...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <a href="{{route('user.quiz-history')}}" class="sl-menu-link {{ Route::is('user.quiz-history') ? 'active' : '' }}">
                <div class="sl-menu-item">
            ...
            <a href="{{route('user.quiz-leaderboard')}}" class="sl-menu-link {{ Route::is('user.quiz-leaderboard') ? 'active' : '' }}">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-people-outline tx-20"></i>
                    <span class="menu-item-label">Leaderboard</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
