...
<head>
    ...
    <title>Talent Hiring Portal</title>
...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{route('/')}}"><i class="icon ion-android-star-outline {{ Route::is('/') ? 'active' : '' }}"></i>Home</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="{{route('admin.home')}}" class="sl-menu-link {{ Route::is('admin.home') ? 'active' : '' }}">
            ...
            <a href="{{route('admin.users')}}" class="sl-menu-link {{ Route::is('admin.users') ? 'active' : '' }}">
                <div class="sl-menu-item">
            ...
            <a href="{{route('admin.quiz')}}" class="sl-menu-link {{ Route::is('admin.quiz') ? 'active' : '' }}">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-people-outline tx-20"></i>
